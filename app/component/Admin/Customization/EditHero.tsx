  ...
  return (
    <>
      <div className="w-full 1000px:flex items-center">
        ...
        <div className="1000px:w-[60%] flex flex-col itme 1000px:mt-[0px] text-center 1000px:text-left mt-[150px]">
          <textarea
            className="dark:text-white resize-none text-[#000000c7] text-[30px] px-3 w-full 1000px:text-[60px] 1500px:text-[70px] font-[600]  "
            placeholder="Improve Your Online Learning Expreience Better Instantly"
          ...
          <textarea
            ...
            placeholder="We have 40k+ Online courses & 500k+ Online registered student. find your desired Course from them"
