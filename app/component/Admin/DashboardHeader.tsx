import ThemesSwitcher from "@/app/utils/ThemesSwitcher";
    ...
    <div className="w-full flex items-center justify-end p-6 fixed top-5 right-0">
      ...
      {open && (
        <div className="w-[350px] h-[50vh] dark:bg-[#111C43] bg-white shadow-xl absolute top-16 z-10  rounded">
          <h2 className="text-center text-[20px] font-Poppins text-black dark:text-white p-3 ">
            Notification
          </h2>
          <div className="dark:bg-[#2d3a4ea1] bg-[#00000013] font-Poppins border-b  dark:border-b-[#ffffff47] border-b-[#0000000f] ">
            ...
            <p className="px-2 text-black dark:text-white ">
              ...
              Veritatis voluptates adipisci cumque quia!
            </p>
          ...
          <div className="dark:bg-[#2d3a4ea1] bg-[#00000013] font-Poppins border-b dark:border-b-[#ffffff47] border-b-[#0000000f] ">
            <div className="w-full flex items-center justify-between p-2 ">
              ...
              <p className="p-2 text-black dark:text-white cursor-pointer">
                Mark as read
              </p>
            </div>
            <p className="px-2 text-black dark:text-white ">
